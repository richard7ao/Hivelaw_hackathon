...
export const MOCK_LAWYERS: LawyerProfile[] = [
  {
    id: "l1",
    name: "Andrea Loreti",
    firm: "Lawhive Housing Team",
    specialisation: "Housing disrepair & tenant claims",
    experience: "10+ years in housing litigation. Experienced in damp & mould disrepair claims against local authorities and private landlords.",
    qualifications: ["SQE qualified", "Housing Law Practitioners Association", "Legal Aid accredited"],
    rating: 4.9,
    casesWon: 312,
    imageUrl: "https://api.dicebear.com/9.x/notionists/svg?seed=Andrea&backgroundColor=e8e0d8",
    profileUrl: "https://www.lawhive.co.uk",
  },
  {
    id: "l2",
    name: "Farah Ismail",
    ...
    experience: "8 years. Specialises in Category 1 hazard enforcement and s.9A fitness claims. Former Shelter legal advisor.",
    qualifications: ["LLB (Hons) Queen Mary", "SQE qualified", "CILEX Fellow"],
    rating: 4.8,
    casesWon: 245,
    imageUrl: "https://api.dicebear.com/9.x/notionists/svg?seed=Farah&backgroundColor=e8e0d8",
    profileUrl: "https://www.lawhive.co.uk",
  },
  {
    id: "l3",
    name: "Tom Mayfield",
    firm: "Lawhive Housing Team",
    specialisation: "Pre-action protocol & tenant representation",
    experience: "6 years. Expert in housing conditions protocol compliance, letter of claim drafting, and single joint expert instructions.",
    qualifications: ["LLM Housing Law (LSE)", "SQE qualified", "Legal Aid accredited"],
    rating: 4.7,
    casesWon: 158,
    imageUrl: "https://api.dicebear.com/9.x/notionists/svg?seed=Tom&backgroundColor=e8e0d8",
    profileUrl: "https://www.lawhive.co.uk",
  },
];
